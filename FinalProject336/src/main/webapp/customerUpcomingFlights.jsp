...
<head>
<meta charset="UTF-8">
<title>View Upcoming Flights</title>
</head>
<body>
...
<%
    ...
    try {
        ...
        if (rs1.next()) {
            ...
            String query2 = "SELECT * FROM Reservations WHERE Account_Number = ? AND Departure_Date > CURDATE() ORDER BY Departure_Date ASC";
            ps2 = con.prepareStatement(query2);
            ps2.setString(1, accountNum);
            rs2 = ps2.executeQuery();

            out.println("<h3>Here are your upcoming flight reservations:</h3>");
